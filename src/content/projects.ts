...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2026",
    summary:
      "Transforming rough 2D floor-plan sketches into interactive 3D spaces and real-time material estimates through AI.",
    coverImage: "/Image/project/SCG/SCG-1.png",
    coverAlt:
      "Sketch2Spec presentation slide with a residential floor plan and SCG challenge context",
    mediaFit: "contain",
    role: "UX/UI Designer & AI Product Researcher",
    ...
    overviewTitle: "Project Overview",
    overviewBody:
      "Developed in response to a real-world business challenge provided by SCG, Sketch2Spec is a PropTech SaaS concept that transforms rough 2D floor-plan sketches into editable 3D environments and generates a real-time Bill of Quantities estimate. The platform explores how AI automation can reduce the communication gap between homeowners, architects, sales teams, and building-material providers by making spatial ideas easier to visualise, edit, and discuss.",
    sections: [
      {
        title: "The Challenge",
        body: "Homeowners often find it difficult to understand conventional 2D floor plans, while architects and sales teams may spend significant time creating 3D visualisations and estimating material requirements manually. This gap can slow decision-making, increase operational effort, and make it harder for customers to feel confident before purchasing materials or approving a design.",
      },
      {
        ...
        images: [
          {
            ...
            alt: "Floor plan with AI-detected wall, door, and window labels",
            width: 815,
            height: 428,
          },
        ],
        impactPoints: [
          {
            ...
            body: "Sketch2Spec is designed to automate parts of the floor-plan interpretation, 3D visualisation, and BOQ-estimation workflow. This could reduce repetitive manual work and shorten the time required to prepare early project estimates.",
          },
          {
            title: "Customer Confidence & Conversion",
            body: "Interactive 3D visualisation helps customers understand spatial layouts and experiment with material choices before committing to a purchase. This can create a clearer and more engaging decision-making experience.",
          },
          {
            title: "Seamless Customer Experience",
            body: "The interface is designed for non-technical users, allowing homeowners to upload or draw a floor plan, review AI-detected structural elements, correct the layout, and explore the generated 3D space without using complex architectural software.",
          },
        ],
      },
      {
        ...
        steps: [
          "Upload or draw a 2D floor plan",
          "AI detects walls, doors, and windows",
          "User reviews and corrects the detected structure",
          "System generates an editable 3D environment",
          "User applies materials and finishes",
          "System generates a preliminary BOQ estimate",
          "Customer and sales team review the proposed design",
        ],
      },
      {
        title: "AI Workflow & Architecture",
        body: "The technical concept combines computer vision, structured geometry, user correction, and 3D rendering.",
        images: [
          {
            src: "/Image/project/SCG/SCG3.png",
            alt: "Sketch2Spec editable 3D workspace with structural controls",
            width: 1883,
            height: 937,
          },
        ],
        subsections: [
          {
            ...
            body: "Prepared and annotated floor-plan data using structural classes such as walls, doors, and windows. The dataset was intended to represent varied drawing styles, scales, and floor-plan formats.",
          },
          {
            title: "Detection and Segmentation",
            body: "Explored a YOLO-based computer-vision workflow to identify and segment architectural elements from sketches and blueprint images.",
          },
          {
            title: "Geometry Processing",
            body: "Detected structural elements can be converted into editable geometric representations that support wall alignment, room boundaries, openings, and later 3D generation.",
          },
          {
            title: "Ground-Truth Validation",
            body: "Model predictions were reviewed against annotated reference data to identify missed objects, incorrect classes, and structural inconsistencies.",
          },
        ],
      },
      {
        title: "Human-in-the-Loop Design",
        body: "Because floor plans can be incomplete, unclear, or drawn in different styles, the system does not treat AI output as automatically correct. After detection, users can review highlighted walls, doors, and windows and make corrections before generating the 3D environment. This design approach improves transparency, gives users control, and helps prevent incorrect AI predictions from continuing through the workflow.",
        points: [
          "User review",
          "Editable AI output",
      ...
      },
      {
        ...
        subsections: [
          {
            title: "Beginner-Friendly SaaS Interface",
            body: "Designed the experience around clear steps, simple language, visible system status, and guided actions for users without architectural software experience.",
          },
          {
            title: "Visual Feedback",
            body: "Used overlays, selection states, and editable controls to make detected architectural elements understandable and correctable.",
          },
          {
            title: "Progressive Complexity",
            body: "Show only essential decisions during the early workflow, while allowing advanced controls to appear when the user needs more detailed editing.",
          },
          {
            title: "AI-Assisted UI Prototyping with Lovable",
            body: "I was responsible for translating the product concept into an interactive UI prototype. To accelerate the early design process, I used Lovable as an AI-assisted prototyping tool while maintaining control over the product direction, user experience, and visual system. Before generating the interface, I prepared a detailed prompt that defined the project context and business problem, target users and key flows, information hierarchy, design-system direction, component behaviour, accessibility expectations, responsive requirements, visual references, and design do’s and don’ts. I then reviewed the generated output, identified usability and visual issues, and refined the prompts through multiple iterations. The AI output was treated as an initial design draft rather than a final solution.",
            steps: [
              "Define product requirements",
              "Identify target users and key tasks",
              "Establish the design system",
              "Write a structured Lovable prompt",
              "Generate the initial prototype",
              "Review usability and visual consistency",
              "Refine prompts and iterate",
              "Validate the final user flow",
            ],
            promptGroups: [
              {
                title: "Prompt Strategy",
                points: [
                  "The prompt was structured to give the AI clear design constraints instead of only requesting a visually attractive interface.",
                ],
              },
              {
                title: "Product Context",
                points: [
                  "AI-powered PropTech SaaS",
                  "Converts 2D floor plans into editable 3D environments",
                  "Supports preliminary BOQ estimation",
                  "Designed for homeowners and building-material teams",
                ],
              },
              {
                title: "Target Users",
                points: [
                  "Homeowners without architectural-software experience",
                  "Architects and contractors reviewing layouts",
                  "Sales teams explaining materials and project estimates",
                ],
              },
              {
                ...
                points: [
                  ...
                  "Clean and trustworthy visual language",
                  "Clear spacing and hierarchy",
                  "Consistent buttons, cards, inputs, and system states",
                  "Accessible contrast",
              ...
              },
              {
                title: "Do",
                points: [
                  "Guide users through one clear task at a time",
                  "Use understandable language",
                  "Show AI-processing status",
                  "Allow users to review and correct detected objects",
                  "Keep primary actions easy to identify",
                  "Maintain consistent component behaviour",
                ],
              },
              {
                title: "Don’t",
                points: [
                  "Overwhelm users with technical controls",
                  "Hide AI uncertainty",
                  "Generate decorative elements without purpose",
                  "Use inconsistent components",
                  "Rely only on colour to communicate status",
                  "Present AI output as automatically correct",
                ],
              },
            ],
            additionalBody: "This process strengthened my ability to communicate design intent through structured prompts. I learned that effective AI-assisted design still requires clear UX reasoning, strong constraints, continuous evaluation, and human decision-making. The quality of the prototype depended not only on the AI tool, but also on how clearly I defined the users, workflows, visual system, and expected behaviour.",
          },
          {
            title: "SCG Product Integration Concept",
            body: "Explored how real building-material products could be connected to the generated 3D environment so customers could preview finishes and receive more understandable preliminary estimates.",
          },
        ],
      },
      {
        title: "Business Model Direction",
        body: "Sketch2Spec is framed as a future-facing B2B2C SaaS opportunity for homeowners, architects, contractors, property developers, and building-material sales teams.",
        points: [
          "Earlier product discovery",
          "Clearer customer conversations",
          "More efficient estimating",
          "Improved design confidence",
          "A stronger connection between visualisation and product selection",
        ],
      },
      {
        title: "Key Learning",
        body: "This project strengthened my ability to connect user experience, computer-vision concepts, and business value within one product direction. I learned how to simplify a technically complex workflow, design a Human-in-the-Loop experience, communicate AI limitations clearly, and consider how automation could support both customer experience and operational efficiency.",
      },
    ],
  },
  {
